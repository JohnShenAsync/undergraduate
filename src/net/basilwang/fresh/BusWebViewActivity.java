...
public class BusWebViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		webViewBus = (WebView) findViewById(R.id.webView1);
		initWebView();
	}
	...
	private void initWebView() {
		...
		sb.append("</tr>");
		sb.append("</table>");
		webViewBus.loadDataWithBaseURL(null, sb.toString(), "text/html", "utf-8",
				null);// 加载数据
