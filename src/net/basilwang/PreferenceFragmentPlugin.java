...
public class PreferenceFragmentPlugin extends Fragment{
    ...
    private int xmlId=R.xml.preferencesfragment;
    private ListView lv;
    public PreferenceFragmentPlugin(int xmlId){
        this.xmlId = xmlId;
    }
    //must be provided
    public PreferenceFragmentPlugin(){
    ...
    //2012-11-23 basilwang we must use this to reload new data
    @Override
    public void onResume() {
    	...
    	postBindPreferences();
    	//2012-11-23 basilwang refresh  VERY IMPORTANT!!!
    	((OnPreferenceAttachedListener)getActivity()).onPreferenceAttached(getPreferenceScreen(), xmlId);
    }
    @Override
